...
async function main() {
  ...
  server.tool(
    "nelly_imessage_send",
    "Send a message through iMessage via Messages.app. Nelly delivers messages to any iMessage contact. The handle is a phone number (+1234567890) or email. Use with care — this sends a REAL message to a REAL person.",
    {
  ...
  server.tool(
    "nelly_imessage_search",
    "Search iMessage conversation history. Nelly reads the local Messages database to find past messages by keyword, contact, or timeframe. Everything stays on your machine.",
    {
  ...
  server.tool(
    "nelly_imessage_conversations",
    "List recent iMessage conversations. Shows who you've been texting, when, and how many messages. Useful for finding the right handle before searching or sending.",
    {
